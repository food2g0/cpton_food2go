...
import 'package:cpton_foodtogo/CustomersWidgets/Cancelled_Order_Detals_Screen.dart';
import 'package:flutter/material.dart';

import '../mainScreen/delivered_order_details_screen.dart';
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()  {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (c) => CancelledOrderDetailsScreen(orderID: orderID)),
        );
      },
      child: Card(
        elevation: 2,
